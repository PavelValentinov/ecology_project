...
response_pag = requests.get('https://rpn.gov.ru/licences/?name=&hazard_class=&region=&types=&inn=&org=&status=%D0%B4%D0%B5%D0%B9%D1%81%D1%82%D0%B2%D1%83%D1%8E%D1%88%D0%B0%D1%8F', headers=headers)
...
while int(page) < int(pagination_end):
    ...
    response = requests.get('https://rpn.gov.ru/licences/?name=&hazard_class=&region=&types=&inn=&org=&status=%D0%B4%D0%B5%D0%B9%D1%81%D1%82%D0%B2%D1%83%D1%8E%D1%88%D0%B0%D1%8F&page=page-' + str(page), headers=headers)
